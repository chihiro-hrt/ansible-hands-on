...
| 接続モード | プロトコル | セッション種別 |
| --- | --- | --- |
| ダイレクトモード | Telnet | ノーマルモード(RW) |
| ダイレクトモード | Telnet | モニターモード(RO) |
| ダイレクトモード | SSH | ノーマルモード(RW) |
| ダイレクトモード | SSH | モニターモード(RO) |
| セレクトモード | Telnet | ノーマルモード(RW) |
| セレクトモード | Telnet | モニターモード(RO) |
| セレクトモード | SSH | ノーマルモード(RW) |
| セレクトモード | SSH | モニターモード(RO) |
