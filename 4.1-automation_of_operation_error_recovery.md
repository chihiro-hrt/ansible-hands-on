...
ip access-list standard "access ansible host only"  
  ...
  20 deny any 
!
!AX2230(config-std-nacl)# 10 permit host 10.5.28.117
!AX2230(config-std-nacl)# packet_write_wait: Connection to 10.5.28.114 port 22: Broken pipe
```
...
```
$ ping -c 3 ax
PING ax (172.31.8.223) 56(84) bytes of data.
