...
<code>ansible_user</code><code>ansible_password</code><code>ansible_port</code>を追記  
...
- PlaybookをSmartCS経由で使う場合でも、一部パラメータを変更するだけで冪等性の担保のあるベンダー製モジュールを利用することができます。
