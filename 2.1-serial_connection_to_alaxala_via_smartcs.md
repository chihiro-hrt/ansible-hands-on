...
<br>
ソフトウェアのバージョンが<code>2.9 (Build:04)</code>であることを確認します。
<br>
...
ソフトウェアバージョンを確認したら、<code>enable</code>コマンドを実行し管理者権限へ移行し<code>show running-config</code>を実行します。
<br>
...
![Teraterm_SelectMode_RW.png](./contents/image/Teraterm_SelectMode_RW.png)
